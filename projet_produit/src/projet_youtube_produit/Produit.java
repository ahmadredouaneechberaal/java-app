...
public class Produit extends javax.swing.JFrame {
    ...
    public Produit() {
     ...
     public void table() {
        ...
        try {
            pstmt = con.prepareStatement("select * from produit", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    private void initComponents() {
        ...
        comrech.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "id","code_produit", "reference", "deseignation", "rangement", "fournisseur", "remise", "prix", "stock" }));
        jPanel3.add(comrech);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || txtref.getText().equals("") || txtdes.getText().equals("")
            ...
            String query = "insert into produit (code_produit,reference,deseignation,rangement,fournisseur,remise,prix,stock) values ('"+txtid.getText()+"','"+txtref.getText()+"','"+txtdes.getText()+"','"+txtran.getText()+"','"+txtfou.getText()+"','"+txtrem.getText()+"','"+txtpri.getText()+"','"+txtsto.getText()+"')";
            try{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (txtid.getText().equals("") || txtref.getText().equals("") || txtdes.getText().equals("")
            ...
            String query = "update produit set code_produit='"+txtid.getText()+"',reference='"+txtref.getText()+"',deseignation='"+txtdes.getText()+"',rangement='"+txtran.getText()+"',fournisseur='"+txtfou.getText()+"',remise='"+txtrem.getText()+"',prix='"+txtpri.getText()+"',stock='"+txtsto.getText()+"' where id ="+id;
            try{
            PreparedStatement stmt = con.prepareStatement(query);
            stmt.execute();
            }catch (SQLException ex) {
...
if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("id")) {
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where id='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where code_produit='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where reference='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where deseignation='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where rangement='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where fournisseur='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where remise='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where prix='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from produit where stock='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
