...
public class Livreurs extends javax.swing.JFrame {
    ...
    public Livreurs() {
     ...
     public void table() {
        //String a[] = {"id", "Nom", "Prenom", "Status", "Produit"};
        PreparedStatement pstmt;
        try {
            pstmt = con.prepareStatement("select * from livreurs", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    private void initComponents() {
        ...
        comty.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Status", "En livraison", "Dispo" }));
        ...
        comrech.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "id", "Nom", "Prenom", "Status", "Produit" }));
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(300, 30, 190, 23);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || txtus.getText().equals("") || txtpa.getText().equals("")
            ...
            //String[] colon = {"id", "Nom", "Prenom", "Status", "Produit"};
            //String[] inf = {txtid.getText(), txtus.getText(), txtpa.getText(), comty.getSelectedItem().toString()};
            String query = "insert into livreurs (id,Nom,Prenom,Status) values ('"+txtid.getText()+"','"+txtus.getText()+"','"+txtpa.getText()+"','"+comty.getSelectedItem().toString()+"')";
            try{
            ...
            //System.out.println(db.queryInsert("livreurs", colon, inf));
            table();
            actualiser();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (txtid.getText().equals("") || txtus.getText().equals("") || txtpa.getText().equals("")
            ...
            String query = "update livreurs set id= '"+txtid.getText()+"', Nom='"+txtus.getText()+"', Prenom ='"+txtpa.getText()+"',Status ='"+comty.getSelectedItem().toString()+"' WHERE id= "+ id ;
            try{
            ...
            //System.out.println(db.queryUpdate("livreurs", colon, inf, "id='" + id + "'"));
            table();
            actualiser();
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "est ce que tu es sure que tu veux suuprimer", "attention!!!", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
            //db.queryDelete("livreurs", "id=" + id);
            String query = "delete from  livreurs WHERE id= "+ id ;
            try{
            PreparedStatement stmt = con.prepareStatement(query,ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
            stmt.execute();
            }catch (SQLException ex) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("id")) {
                //rs = db.querySelectAll("livreurs", "id LIKE '%" + txtrech.getText() + "%' ");
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from livreurs where id='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                //rs = db.querySelectAll("livreurs", "Nom LIKE '%" + txtrech.getText() + "%' ");
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from livreurs where Nom='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                ...
                //rs = db.querySelectAll("livreurs", "Prenom LIKE '%" + txtrech.getText() + "%' ");
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from livreurs where Prenom='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
                tbl_user.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Status")) {
                //rs = db.querySelectAll("livreurs", "Status LIKE '%" + txtrech.getText() + "%' ");
                PreparedStatement pstmt;
                try {
                pstmt = con.prepareStatement("select * from livreurs where Status='"+txtrech.getText()+"'", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = pstmt.executeQuery();
                }catch (SQLException ex) {
                Logger.getLogger(Livreurs.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private final javax.swing.JComboBox comty = new javax.swing.JComboBox();
